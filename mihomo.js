...
// 1. Embed your base configuration cleanly as a native JavaScript Object
let config = {
  "hosts": {
...
// 2. Fetch the upstream subscription nodes via Sub-Store engine
...
// 3. Append the raw nodes to the root level array
config.proxies.push(...proxies);

// 4. Inject strict case-sensitive ordered nodes into target proxy groups
...
// Custom native YAML serializer to bypass Sub-Store's wrapper dependencies entirely
function jsonToYaml(obj, indent = 0) {
	...
	if (Array.isArray(obj)) {
		...
		// Check if it's a simple flat array of strings (like proxies or rules)
...
// 5. Output the structural string text directly to $content
